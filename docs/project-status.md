...
**Current branch**: `feat/migration-cutover` (post-cutover punch list 진행 중 — W3.5 / W2.4 / W8.1 완료, 다음은 D-block sketch 플랜들의 결정)
...
### 3.1 다음 한 발
**SKETCH 플랜의 D-block 결정 sweep.** 실행 가능 detailed 플랜은 모두 소진(W3.5 / W2.4 / W8 Part 1 완료). 다음은 W5(업로드) / W6(인증) / W7(GPU 워커) / W8 Part 2(SSM) / W9(reg_covar 캘리브레이션)의 D-block을 사용자와 정리해서 플랜을 executable 상태로 끌어올리는 단계. 우선순위는 사용자 결정.
